...
class Membro(base):
    ...
    def __repr__(self):
        return f'<Membro(name={self.name}, start_date={self.start_date}, course={self.course}, actual_area={self.actual_area}, more_than1_area={self.more_than1_area}, actual_charge={self.actual_charge}, more_than1_charge={self.more_than1_charge}, menager={self.menager})>'
...
class area_hist(base):
    ...
    def __repr__(self):
        return f'<area_hist(area={self.area}, start_date={self.start_date}, end_date={self.end_date})>'
